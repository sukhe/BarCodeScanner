...
При старте программы запрашивается пароль (см. файл Screenshots/01.LoginForm.jpg). 
![Форма запроса пароля](https://bitbucket.org/sukhe/barcodescanner/src/62e73d3471dc91b87eb839af9e108d6f937ebf83/Screenshots/01.LoginForm.jpg?at=master "-Форма запроса пароля-")
