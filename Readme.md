...
![Форма запроса пароля](./Screenshots/01.LoginForm.jpg? =240x320 "Форма запроса пароля") | ![Основная форма приложения](./Screenshots/02.MainForm.jpg =240x320 "Основная форма приложения")
...
со списком продукции выбранного документа, нажав Enter в списке документов на нужной строке.
