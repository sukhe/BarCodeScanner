...
2. Список документов
	Здесь можно увидеть список загруженных на сканер документов или удалить какой-либо документ (Внимание! Отсканированные штрихкоды пропадут!). 
	Также можно посмотреть внутренне содержимое файла XML - как с форматированием, так и просто в виде текста.
3. Посмотреть лог
